...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa', 'admin']], function () {
    ...
    // Dosare
    Route::delete('dosares/destroy', 'DosareController@massDestroy')->name('dosares.massDestroy');
    Route::post('dosares/media', 'DosareController@storeMedia')->name('dosares.storeMedia');
    Route::post('dosares/ckmedia', 'DosareController@storeCKEditorImages')->name('dosares.storeCKEditorImages');
    Route::resource('dosares', 'DosareController');
