...
class DosareController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.dosares.index', compact('dosares'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.dosares.create', compact('emails'));
    }
    ...
    public function store(StoreDosareRequest $request)
    {
        ...
        return redirect()->route('frontend.dosares.index');
    }
    ...
    public function edit(Dosare $dosare)
    {
        ...
        return view('frontend.dosares.edit', compact('dosare', 'emails'));
    }
    ...
    public function show(Dosare $dosare)
    {
        ...
        return view('frontend.dosares.show', compact('dosare'));
    }
