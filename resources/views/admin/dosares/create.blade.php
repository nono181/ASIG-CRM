...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.dosares.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cui') ? 'is-invalid' : '' }}" type="number" name="cui" id="cui" value="{{ old('cui', '') }}" step="1" required>
                @if($errors->has('cui'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('incident_date') ? 'is-invalid' : '' }}" type="text" name="incident_date" id="incident_date" value="{{ old('incident_date') }}">
