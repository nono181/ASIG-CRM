    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.dosares.update", [$dosare->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $dosare->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $dosare->first_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="company_name" id="company_name" value="{{ old('company_name', $dosare->company_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cui" id="cui" value="{{ old('cui', $dosare->cui) }}" step="1" required>
                            @if($errors->has('cui'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cui') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="incident_date" id="incident_date" value="{{ old('incident_date', $dosare->incident_date) }}">
