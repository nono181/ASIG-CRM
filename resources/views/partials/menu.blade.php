    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('asigurari_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/dosares*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/dosares*") ? "active" : "" }}" href="#">
                            <i class="fa-fw nav-icon fas fa-cogs">

                            </i>
                            <p>
                                {{ trans('cruds.asigurari.title') }}
                                <i class="right fa fa-fw fa-angle-left nav-icon"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            @can('dosare_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.dosares.index") }}" class="nav-link {{ request()->is("admin/dosares") || request()->is("admin/dosares/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.dosare.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
